...
router.get('/avaitor/get/latest/crashpoint21', crashAviatorController.getAllCrashEntries);
router.get('/avaitor/get/crashpoint', crashAviatorController.getAllCrashLatestEntries);
...
// router.delete('/avaitor/reset/crashpointall', crashAviatorController.resetAviatorGame);
